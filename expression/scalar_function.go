...
type ScalarFunction struct {                         //标量函数
	FuncName model.CIStr
	// RetType is the type that ScalarFunction returns.
	// TODO: Implement type inference here, now we use ast's return type temporarily.
	RetType  *types.FieldType                       //函数参数的类型
	Function builtinFunc                            //内置函数，函数中可会获取参数
	hashcode []byte
}
...
// NewFunction creates a new scalar function or constant via a constant folding.   //常量折叠
